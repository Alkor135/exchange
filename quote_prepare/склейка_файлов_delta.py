...
def run(files: list[Path], razmer: int, year: str, target_dir: Path) -> None:
    ...
    target_name: str = f'{tiker}_00_delta{razmer}_splice_{year}.txt'  # Создание имени новому файлу
...
if __name__ == "__main__":
    ...
    files_path: list[Path] = list(source_dir_tick.glob(f'*{razmer}*{year}*.csv'))
    # print(files_path)
